    ...
    function (MockServer, JSONModel, UriParameters, Log) {
        ...
        var oMockServerInterface = {
            ...
            * Initializes the mock server asynchronously
            @protected
            * @param {object} oOptions Parameter
            ...
            init: function (oOptionsParameter) {
                ...
                return new Promise(function (fnResolve, fnReject) {
                    ...
                    oManifestModel.attachRequestCompleted(function () {
                        ...
                        //create a mock server instance or stop the existing one to reinitialize if (!oMockServer) {
                        if (!oMockServer) {
                    ...
                    var sErrorParam = oOptions.errorType || oUriParameters.get("errorType"); var iErrorCode = sErrorParam === "badRequest" ? 400 : 500;
                    if (sErrorParam) {
                        aRequests.forEach(function (aEntry) {
                    ...
                    oMockServer.start();
                    Log.info("Running the app with mock data"); fnResolve();
