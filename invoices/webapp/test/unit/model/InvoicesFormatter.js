...
//@ts-nocheck
sap.ui.define([
    "C23C249/invoices/model/InvoicesFormater",
    ...
    */
    function (InvoicesFormater, ResourceModel) {
        QUnit.module("Qnvoices Status", {
            beforeEach: function () {
                this._oResourceModel = new ResourceModel({
                    bundleUrl : sap.ui.require.toUrl("C23C249/invoices") + "/i18n/i18n.properties"
                });
            },
            afterEach: function () {
        ...
        QUnit.test("Should return the Invoice Status", function (assert) {
            ...
            let fnIsolatedFormatter = InvoicesFormater.invoiceStatus.bind(oControllerStub);
            //Assert
